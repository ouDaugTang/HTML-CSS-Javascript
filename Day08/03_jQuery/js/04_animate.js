...
$(function () {
    ...
    */
    ...
    /* 
    animate() 함수로 지정가능한 스타일 속성: width, height, opacity, marginLeft, marginRight, marginTop, marginBottom, paddingLeft, paddingRight, paddingTop, paddingBottom, left, right, top, bottom, backgroundColor, color, borderWidth, borderColor, borderRadius, fontSize, zIndex, transform, boxShadow, filter, textShadow, scrollLeft, scrollTop, lineHeight, letterSpacing, fontWeight, fontStyle, textDecoration, textIndent, wordSpacing, verticalAlign, overflow, float, clear, display, visibility
    animate() 함수로 지정가능한 스타일 속성: backgroundPositionX, backgroundPositionY, borderBottomWidth, borderLeftWidth, borderRightWidth, borderSpacing, borderTopWidth, borderWidth, bottom, fontSize, height, left, letterSpacing, lineHeight, margin, marginBottom, marginLeft, marginRight, marginTop, maxHeight, maxWidth, minHeight, minWidth, opacity, outlineWidth, padding, paddingBottom, paddingLeft, paddingRight, paddingTop, right, textIndent, top, width, wordSpacing
    */
